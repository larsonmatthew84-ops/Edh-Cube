...
const commanderData = [
        ...
        { rank: 29, name: "Sephiroth, Fabled SOLDIER", colors: "Mono-Black", logic: "Aristocrat (Sacrifice recurring or token creatures to draw cards and flip Sephiroth.", picks: ["Gravecrawler", "Ophiomancer", "Grave Titan", "Pitiless Plunderer"], back: true },
  ...
  { 
    ...
    name: "Norin the Wary", 
    colors: "Mono-Red", 
    logic: "Hyper-recursive flicker and ETB trigger chaos. Capitalizes on Norin's constant blinking mechanics to fuel permanent token production and relentless burn triggers.", 
    picks: ["Purphoros, God of the Forge", "Impact Tremors", "Genesis Chamber", "Confusion in the Ranks"] 
  },
  { 
    rank: 297, 
